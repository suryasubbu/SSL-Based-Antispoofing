...
def read_pickle_files(base_directory, feature_type, speaker_no, train_type):
    ...
    speaker_path = os.path.join(base_directory, 'FF_V2', speaker_no, train_type)
...
def visualize_umap(data, labels, feature_type, output_directory, model_no, results_df, speaker_no):
    ...
    warm_colors = px.colors.sequential.Viridis[1:]  # Modify this list to your preferred warm color scheme
...
if __name__ == "__main__":
  ...
  "passt_base"]  # List of feature types
    ...
    results_output_path = os.path.join(base_directory, "ff_umap_distances_closest_each_summary.csv")
